...
export const metadata: Metadata = {
  title: "Smart Seller Programs | Childs Real Estate",
  description:
    "Compare our Gold, Diamond, and Platinum Smart Seller Programs. Transparent listing fees starting at 1% — more service, less cost. Serving Utah County and the Salt Lake Valley.",
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto mb-6">
            ...
            More service. Less commission. Seller can cancel anytime.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8 items-start">
            ...
            <div className="bg-background rounded-2xl border-2 border-accent/50 p-8 flex flex-col relative shadow-lg">
              ...
              <div className="flex-1 space-y-2.5">
                <SectionLabel>Everything in Diamond, plus:</SectionLabel>
                <ul className="space-y-2.5">
